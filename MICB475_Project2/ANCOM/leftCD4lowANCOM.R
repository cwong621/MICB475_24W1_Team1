...
aids <- subset_samples(ps_left, Visit==2 & CD4._Cat=="<200" & Cohort_Short=="A")
set.seed(1)
...
p_v2 = df_fig_v2 %>%
  ...
  labs(x = NULL, y = NULL, title = "Left, CD4 count <200, Before Treatment") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
p_v2

ggsave("ANCOM/leftCD4lownaive.jpg", p_v2)
