...
resp <- subset_samples(ps_left, response_patient=="nonresponsive" & Cohort_Short!="B")
set.seed(1)
...
p_v2 = df_fig_v2 %>%
  ...
  labs(x = NULL, y = NULL, title = "Left, nonresponsive") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
p_v2

ggsave("ANCOM/leftnonrespv2v3.jpg", p_v2)
