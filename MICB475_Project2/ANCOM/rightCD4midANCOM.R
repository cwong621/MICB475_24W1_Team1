...
aids <- subset_samples(ps_right, Visit==2 & CD4._Cat=="200-499" & Cohort_Short=="A")
set.seed(1)
...
p_v2 = df_fig_v2 %>%
  ...
  labs(x = NULL, y = NULL, title = "Right, CD4 count 200-499, Before Treatment") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5))
p_v2

ggsave("ANCOM/rightCD4midnaive.jpg", p_v2)
