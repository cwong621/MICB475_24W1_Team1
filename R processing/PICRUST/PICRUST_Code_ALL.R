...
left_v2_NvHgg <- PICRUST_function(left_v2_NvH, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort A, Nonresponsive vs Healthy, Week 0")
...
left_v2_RvHgg <- PICRUST_function(left_v2_RvH, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort A, Responsive vs Healthy, Week 0")
...
left_v2_RvNgg <- PICRUST_function(left_v2_RvN, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort A, Responsive vs Nonresponsive, Week 0")
...
right_v2_NvHgg <- PICRUST_function(right_v2_NvH, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort B, Nonresponsive vs Healthy, Week 0")
...
right_v2_RvHgg <- PICRUST_function(right_v2_RvH, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort B, Responsive vs Healthy, Week 0")
...
right_v2_RvNgg <- PICRUST_function(right_v2_RvN, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort B, Responsive vs Nonresponsive, Week 0")
...
left_v3_NvHgg <- PICRUST_function(left_v3_NvH, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort A, Nonresponsive vs Healthy, Week 24")
...
left_v3_RvHgg <- PICRUST_function(left_v3_RvH, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort A, Responsive vs Healthy, Week 24")
...
left_v3_RvNgg <- PICRUST_function(left_v3_RvN, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort A, Responsive vs Nonresponsive, Week 24")
...
right_v3_NvHgg <- PICRUST_function(right_v3_NvH, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort B, Nonresponsive vs Healthy, Week 24")
...
right_v3_RvHgg <- PICRUST_function(right_v3_RvH, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort B, Responsive vs Healthy, Week 24")
...
right_v3_RvNgg <- PICRUST_function(right_v3_RvN, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort B, Responsive vs Nonresponsive, Week 24")
...
right_v2v3_Rgg <- PICRUST_function(right_v2v3_R, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort B, Responsive, Week 24 vs Week 0")
...
right_v2v3_NRgg <- PICRUST_function(right_v2v3_NR, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort B, Nonresponsive, Week 24 vs Week 0")
...
right_v2v3_Hgg <- PICRUST_function(right_v2v3_H, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort B, Healthy, Week 24 vs Week 0")
...
left_v2v3_Rgg <- PICRUST_function(left_v2v3_R, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort A, Responsive, Week 24 vs Week 0")
...
left_v2v3_NRgg <- PICRUST_function(left_v2v3_NR, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort A, Nonresponsive, Week 24 vs Week 0")
...
left_v2v3_Hgg <- PICRUST_function(left_v2v3_H, abundance_data) +
  labs(x = "Log2FoldChange", y="Pathways", title="Cohort A, Healthy, Week 24 vs Week 0")
