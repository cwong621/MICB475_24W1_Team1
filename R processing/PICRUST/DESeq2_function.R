...
DEseq2_function = function(abundance_table,metadata,response_patient_by_visit){
...
# Update the subject part to your own metadata column of interest
  DESeq2_colnames[DESeq2_colnames == response_patient_by_visit] <- "Group_group_nonsense"
